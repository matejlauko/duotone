/**
 * Icons copied from Radix Icons (https://icons.radix-ui.com/)
 */
...
export function createIcon(
  getEl: (props: React.SVGAttributes<SVGSVGElement>) => React.ReactElement
) {
  const Icon = React.forwardRef<React.ElementRef<typeof UIIcon>, IconProps>(function Icon(
    { label, color, size, ...restProps },
    forwardedRef
  ) {
    const el = (props: React.SVGAttributes<SVGSVGElement>) => getEl(props)
...
export const ResetIcon = createIcon((props) => (
  <svg
    width="15"
    height="15"
    viewBox="0 0 15 15"
...
export const SlashIcon = createIcon((props) => (
  <svg
    width="15"
    height="15"
    viewBox="0 0 15 15"
...
export const ClearIcon = createIcon((props) => (
  <svg
    width="15"
    height="15"
    viewBox="0 0 15 15"
